...
import numpy as np
import logging
from src.config import (BOT_TOKEN, TARGET_CHANNEL_ID, TELEGRAM_API_ID, TELEGRAM_API_HASH, 
...
from src.core.shap_explainer import generate_shap_plots as actual_shap_generator
...
def load_model_artifacts():
    ...
    try:
        ...
        mlb_path = 'saved_models/mlb_trained.joblib'
        hier_map_path = 'saved_models/idx_to_hier_map_trained.joblib' # Предполагается, что это idx -> label
        model_weights_path = 'saved_models/fine_tuned_electra.pt'
